  ...
  return (
    ...
    >
        ...
        <motion.h1 
          ...
          className='text-4xl font-bold text-indigo-400 dark:text-indigo-800 border-l-4 border-indigo-400 pl-4'
        >
        ...
        {info.map((experience, index) => (
          <motion.div
            ...
            style={{
              ...
              borderImage: 'linear-gradient(135deg, #654321, #123456) 1',
              backgroundColor: (expandedIndices.includes(index) || isInitialLoad)
          ...
          >
            ...
            <div className="header flex justify-between">
              <div className="left-side">
                <h2 className="text-xl font-bold dark:text-indigo-800">{experience.jobTitle}</h2>
                <p className="text-indigo-400">{experience.companyName}</p>
              </div>
              <div className="right-side text-right">
                <p className="text-gray-400 dark:text-dark-secondary">{experience.duration}</p>
                <p className="text-gray-400 dark:text-dark-accent">{experience.location}</p>
...
//       {
//         jobTitle: "Internship Trainee",
//         companyName: "KPMG Global Services (KGS), Mumbai",
//         location: "On-Site",
//         duration: "Jan 2025 - Present",
//         description:
//         [
...
//       animate={{ opacity: 1 }}
//       transition={{ duration: 1 }}
//       className='about-container lg:flex-row p-8 rounded-lg shadow-lg bg-black-800 text-white'
//     >
//         <div className="flex justify-between items-center mb-6 lg:mb-12 p-2">
//         <motion.h1 
//           initial={{ x: -50, opacity: 0 }}
//           animate={{ x: 0, opacity: 1 }}
//           transition={{ duration: 1, delay: 0.2 }}
//           className='text-4xl font-bold text-indigo-400 border-l-4 border-indigo-400 pl-4'
//         >
//             Professional Experience
//         </motion.h1>
